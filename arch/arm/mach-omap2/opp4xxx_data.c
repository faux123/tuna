...
#define OMAP4460_VDD_MPU_OPP50_UV		 959000
#define OMAP4460_VDD_MPU_OPP75_UV		1042000	//unofficial OPP75
#define OMAP4460_VDD_MPU_OPP100_UV		1126000
#define OMAP4460_VDD_MPU_OPP125_UV		1178000	//unofficial OPP125
#define OMAP4460_VDD_MPU_OPPTURBO_UV		1231000
#define OMAP4460_VDD_MPU_OPPTURBOPLUS_UV	1262000 //unofficial OPPTURBOPLUS
#define OMAP4460_VDD_MPU_OPPNITRO_UV		1291000
...
struct omap_volt_data omap446x_vdd_mpu_volt_data[] = {
	...
	VOLT_DATA_DEFINE(OMAP4460_VDD_MPU_OPP75_UV, OMAP44XX_CONTROL_FUSE_MPU_OPP50, 0xf4, 0x0c, OMAP_ABB_NOMINAL_OPP),
	VOLT_DATA_DEFINE(OMAP4460_VDD_MPU_OPP100_UV, OMAP44XX_CONTROL_FUSE_MPU_OPP100, 0xf9, 0x16, OMAP_ABB_NOMINAL_OPP),
	VOLT_DATA_DEFINE(OMAP4460_VDD_MPU_OPP125_UV, OMAP44XX_CONTROL_FUSE_MPU_OPP100, 0xf9, 0x16, OMAP_ABB_NOMINAL_OPP),
	VOLT_DATA_DEFINE(OMAP4460_VDD_MPU_OPPTURBO_UV, OMAP44XX_CONTROL_FUSE_MPU_OPPTURBO, 0xfa, 0x23, OMAP_ABB_NOMINAL_OPP),
	VOLT_DATA_DEFINE(OMAP4460_VDD_MPU_OPPTURBOPLUS_UV, OMAP44XX_CONTROL_FUSE_MPU_OPPTURBO, 0xfa, 0x23, OMAP_ABB_NOMINAL_OPP),
	VOLT_DATA_DEFINE(OMAP4460_VDD_MPU_OPPNITRO_UV, OMAP44XX_CONTROL_FUSE_MPU_OPPNITRO, 0xfa, 0x27, OMAP_ABB_NOMINAL_OPP),
...
#ifdef CONFIG_PRE_UNDERVOLT
#define OMAP4460_VDD_CORE_OPP50_UV		 900000
#define OMAP4460_VDD_CORE_OPP100_UV		1055000
#define OMAP4460_VDD_CORE_OPP100_PLUS_UV	1113000
#define OMAP4460_VDD_CORE_OPP100_OV_UV		1169000
#else
...
struct omap_volt_data omap446x_vdd_core_volt_data[] = {
	...
	VOLT_DATA_DEFINE(OMAP4460_VDD_CORE_OPP100_PLUS_UV, OMAP44XX_CONTROL_FUSE_CORE_OPP100, 0xf9, 0x16, OMAP_ABB_NONE),
...
static struct omap_opp_def __initdata omap446x_opp_def_list[] = {
...
#ifndef CONFIG_GPU_OVERCLOCK
	/* SGX OPP1 - OPP50 */
	OPP_INITIALIZER("gpu", "dpll_per_m7x2_ck", "core", true, 115200000, OMAP4460_VDD_CORE_OPP50_UV),
	/* SGX OPP2 - OPP100 */
	OPP_INITIALIZER("gpu", "dpll_per_m7x2_ck", "core", true, 230400000, OMAP4460_VDD_CORE_OPP100_UV),
	/* SGX OPP3 - OPPOV */
	OPP_INITIALIZER("gpu", "dpll_per_m7x2_ck", "core", true, 345600000, OMAP4460_VDD_CORE_OPP100_PLUS_UV),
#else
	/* SGX OPP1 - OPP50 */
	...
	/* SGX OPP3 - OPPOV */
	OPP_INITIALIZER("gpu", "dpll_per_m7x2_ck", "core", true, 403200000, OMAP4460_VDD_CORE_OPP100_OV_UV),
#endif
	/* FDIF OPP1 - OPP25 */
